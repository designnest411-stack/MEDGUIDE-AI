...
export function ConsultRunIndicator() {
  ...
  return (
    <Link
      to="/consultation"
      className="fixed bottom-24 right-5 z-50 flex max-w-[15rem] items-center gap-2 rounded-full border border-primary/40 bg-card/95 px-3.5 py-2 shadow-lg backdrop-blur transition-colors hover:border-primary"
    >
      <Loader2 className="h-3.5 w-3.5 shrink-0 animate-spin text-primary" />
      <span className="min-w-0">
        <span className="block font-mono text-[0.6rem] uppercase tracking-[0.16em] text-primary">
          Agents running
        </span>
